...
public class AddressDaoTest {
	...
	public void testInsert() {
		...
		entity.setConsignee("收货人姓名");
		entity.setEmail("asd@asd.com");
		entity.setAddress("sdfff");
		entity.setZipcode("aaaaa");
		entity.setTel("1655556665");
		entity.setType(EAddress.home);
		dao.insert(entity);
	...
	public void testUpdate() {
		...
		dao.update(entity);
		assertEquals(address, dao.get(TestConstants.uidpk).getAddress());
	}
	...
	public void testUpdateFields() {
		...
		String address = "北京";
		map.put(MapperConstant.address, address );
