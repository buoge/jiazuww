...
public class GalleryDaoTest {
	...
	public void testGet() {
		...
		assertEquals(TestConstants.uid, entity.getGoodsuid());
	}
	...
	public void testInsert() {
		...
		entity.setUid(uid);
		entity.setGoodsuid(GlobalUtil.getUUID());
		entity.setImg("good.jpg");
		entity.setThumb("as.png");
		entity.setOriginal("org.jpg");
		entity.setBigimg("good.jpg");
		String title = "缩略图简介";
	...
	public void testUpdate() {
		...
		dao.update(entity);
		assertTrue(dao.get(TestConstants.uidpk).isdefault());
	}
	...
	public void testUpdateFields() {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put(MapperConstant.UID, TestConstants.uidpk);
		map.put(MapperConstant.isdefault, true);
