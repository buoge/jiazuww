...
public class WishesDaoTest {
	...
	public void testGet() {
		...
		assertEquals(TestConstants.uid, entity.getGroupuid());
	...
	public void testInsert() {
		...
		entity.setUid(uid);
		entity.setGroupuid(TestConstants.uid);
		dao.insert(entity);
	...
	public void testUpdate() {
		entity = dao.get(TestConstants.uidpk);
		entity.setType(EWish.defaultwish);
		dao.update(entity);
		assertEquals(EWish.defaultwish, dao.get(TestConstants.uidpk).getType());
	}
