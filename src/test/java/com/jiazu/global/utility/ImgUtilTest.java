...
public class ImgUtilTest {
	...
	private static String imgwater = StrUtil.trim(ClassLoader.getSystemResource("images/water.jpg").getFile(), "/");
	...
	public void testWaterMark() {
		...
		String actual = ImgUtil.waterMark(imgwater, ImgUtil.southeast, 50, imgnature);
		assertEquals(expected, actual);
	}
	...
	public void testTextWaterMark() {
		...
		String actual = ImgUtil.waterTextMark("www.JiaZu.com", 60, "#000", ImgUtil.southeast, 50, imgnature);
		assertEquals(expected, actual);
	}
